...
export const tripDays: TripDay[] = [
  ...
  },
  {
    ...
    cover: cover.osaka,
    mapFile: '2026-09-30-arrival-osaka.html',
    mapRouteScenes: [['kix-arrival'], ['kuroshio-ticket', 'stamp-kix'], ['to-hotel-osaka'], ['osaka-checkin'], ['dotonbori'], ['dotonbori'], ['dotonbori'], ['shinsaibashi-night'], ['shinsaibashi-night']],
  ...
  },
  {
    ...
    timeline: [
      ...
      { id: 'stamp-shirahama', time: 'По прибытии', title: 'Найти печать с запахом океана', kind: 'quest', details: ['Вторая печать прячется на Shirahama Station.'] },
  ...
  },
  {
    ...
    mapRouteScenes: [['to-usj'], ['to-usj'], ['to-usj', 'usj-entry'], ['harry-potter'], ['express-missions'], ['express-missions'], ['express-missions'], ['halloween'], ['jurassic']],
  ...
  },
  {
    ...
    mapRouteScenes: [['to-nara'], ['to-nara'], ['nara-park'], ['todaiji'], ['kasuga'], ['nara-food'], ['nara-food'], ['nara-food'], ['pokemon-osaka'], ['pokemon-osaka'], ['pokemon-osaka']],
  ...
  },
  {
    ...
    mapRouteScenes: [['move-kyoto'], ['move-kyoto'], ['move-kyoto', 'stamp-gion'], ['tazuru-bags'], ['kiyomizu'], ['old-streets'], ['old-streets'], ['old-streets'], ['gion'], ['gion'], ['gion'], ['gion'], ['kaiseki']],
  ...
  },
  {
    ...
    timeline: [
      ...
      { id: 'stamp-akihabara', time: 'Около 14:15', title: 'Поймать электрическую печать', kind: 'quest', details: ['STAMP #4 — Akihabara Station. Искать 駅スタンプ / Eki Stamp в районе Central Gate станции JR.'] },
      { id: 'kanda-myojin-anime', time: '14:30–15:00', title: 'Попросить удачу у хранителя Akihabara', kind: 'quest', details: ['От станции около 7–10 минут пешком до Kanda Myojin — святилища из мира Love Live! и Steins;Gate.', 'Получить goshuin, найти иллюстрированную ema и не фотографировать там, где это запрещено.'] },
  ...
  },
  {
    ...
    timeline: [
      ...
      { id: 'sensoji', time: '08:00–09:45', title: 'Разбудить старый Tokyo', kind: 'quest', details: ['Пройди под Kaminarimon, загляни на Nakamise и доберись до Senso-ji, пока храм ещё не растворился в толпе.', 'Если захочется оставить знак этого утра — здесь можно получить goshuin. Вход на территорию свободный.'] },
