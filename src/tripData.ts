...
export const tripDays: TripDay[] = [
  ...
  },
  {
    ...
    timeline: [
      ...
      },
      {
        ...
        kind: 'quest',
        details: ['От Ebisu Bridge пройти около трёх минут по Shinsaibashi-suji до DAISO Shinsaibashi-suji 2-chome, 3F. Он открыт до 22:00, поэтому блокнот можно выбрать по пути и без спешки.', 'Выбрать маленький блокнот A6/B6 с плотной обложкой и клеткой или точками: 方眼ノート (hōgan nōto) / ドット方眼. Добавить одну наклейку シール и любимую ручку — это и будет ваш настоящий Travel Passport.', 'На первой странице написать: “30.09.2026 · Osaka · 旅” и вклеить карточку с первой печатью KIX. Eki stamp собирайте сюда; goshuin для храмов всегда живут в отдельной goshuincho-книжке.'],
      },
      {
  ...
  },
  {
    ...
    vibe: dayVibe('gentle', 'Чиловый', 'День с воздухом', 'Океан, свободный обед и одна спокойная остановка вечером — этого уже достаточно для прекрасного дня.', 'Оставь себе длинную паузу у воды.', '🌊'),
    cover: cover.osaka,
    ...
    timeline: [
      ...
      { id: 'osaka-zagin', time: 'После магазинов', title: 'Согреться за миской ramen', kind: 'food', food: primaryFood('Ужин', 'Torisoba Zagin Niboshi', 'Ramen с niboshi — тёплое завершение длинного дня.', undefined, 'Можно спокойно выбрать другой ramen рядом.'), details: [] },
    ],
  },
  {
    id: 'usj',
    ...
    vibe: dayVibe('full', 'Насыщенный', 'Один большой мир', 'Сегодня весь день живёт внутри USJ — не нужно ничего успевать за пределами парка.', 'Сначала смотрите на время Express Pass, а между поездками просто исследуйте парк.', '🎢'),
    cover: cover.osaka,
  ...
  },
  {
    ...
    vibe: dayVibe('steady', 'Живой', 'Нара, потом Osaka', 'Утро принадлежит храмам и оленям, вечер — Pokémon. Между ними не нужно бороться за идеальный темп.', 'Главное время дня — бронь Pokémon Café в 18:00. Если захочется сократить вечер, оставьте в Shinsekai только ужин и один круг под огнями.', '🦌'),
    cover: cover.osaka,
    ...
    timeline: [
      ...
      { id: 'naramachi', time: '~13:30–15:30', title: 'Потеряться в улочках старой Nara', kind: 'place', details: ['Пройти через Naramachi среди невысоких machiya, маленьких лавочек и тихих переулков. Никакого списка не нужно — достаточно выбрать симпатичную улицу и немного побродить.', 'Около 15:30 мягко сворачивать к Kintetsu-Nara Station, чтобы дальше нигде не пришлось бежать.'] },
      { id: 'back-to-osaka', time: '~16:10', title: 'Сменить оленей на неон Osaka', kind: 'route', details: ['Kintetsu-Nara → Osaka-Namba, затем до Shinsaibashi и Daimaru.', 'Ориентир — оказаться у Daimaru к 17:15–17:30. Запас останется на лифт, короткую передышку и спокойный вход по брони.'] },
      { id: 'pokemon-osaka', time: '18:00–19:30 · забронировано', title: 'Занять наш столик в мире Pokémon', kind: 'quest', details: ['Бронь подтверждена на двоих. К 17:45 подняться в Pokémon Café Osaka на 9F Daimaru Shinsaibashi.', 'Стол наш на 90 минут — до 19:30. Можно взять напиток или десерт по настроению и оставить место для kushikatsu в Shinsekai.'] },
      { id: 'shinsekai-food', time: '~20:00', title: 'Попробовать вечерний Shinsekai', kind: 'food', food: primaryFood('Перекус / еда вечером', 'Shinsekai Kawachiya Honten', 'Kushikatsu в самом подходящем для него районе.', [{ name: 'Daruma', note: 'Kushikatsu, если Kawachiya не подойдёт.' }], 'Можно спокойно выбрать другое место рядом в Shinsekai.'), details: ['После кафе: Shinsaibashi → Midosuji Line → Dobutsuen-mae, затем короткая прогулка к огням Shinsekai.'] },
  ...
  },
  {
    ...
    vibe: dayVibe('gentle', 'Чиловый', 'Медленный Kyoto', 'Улицы, заселение, вечерние фонари и домашний ужин складываются в одну неспешную прогулку.', 'После заселения ничего не нужно догонять.', '🍂'),
    cover: cover.kyoto,
    ...
    timeline: [
      ...
      { id: 'kaiseki', time: '~18:30', title: 'Поужинать по-домашнему в Kyoto', kind: 'food', food: primaryFood('Ужин', 'Mamaya', 'Домашняя Kyoto-кухня и obanzai — уютно и без лишней торжественности.', undefined, 'Можно спокойно выбрать другое место рядом в Pontocho.'), details: ['После Pontocho неспешно пройти вдоль Kamo River и вернуться в Tazuru.'] },
    ],
  },
  {
    id: 'fushimi',
    ...
    timeline: [
      ...
      { id: 'kyoto-ramen', time: 'К ужину', title: 'Согреться за миской ramen', kind: 'food', food: primaryFood('Ужин', 'Menya Inoichi', 'Dashi ramen для простого и тёплого вечера.', [{ name: 'Menya Inoichi Hanare', note: 'Вариант dashi ramen, который уже был в маршруте.' }], 'Можно спокойно выбрать другой ramen рядом.'), details: [] },
      { id: 'kyoto-night-finale', time: 'Когда захочется', title: 'Дать Kyoto самому закончить этот день', kind: 'rest', details: ['Если силы закончились — спокойно возвращайтесь в Tazuru: душ, чай и отдых будут прекрасным завершением большого дня.', 'Если хочется ещё немного Kyoto — сделайте короткий круг вдоль Kamo River или по тихим вечерним улицам, не пытаясь успеть куда-то ещё. После этого — домой в Tazuru.'] },
    ],
  },
  {
    id: 'arashiyama',
    ...
    vibe: dayVibe('adventure', 'Прогулочный', 'Длинная прогулка', 'День для ног и глаз: горы, бамбук, каменные лица, а вечером — мягкий свет станции.', 'Если устанете, пропустите одно место, но сохраните тихий вечер.', '🎋'),
    cover: cover.kyoto,
  ...
  },
  {
    ...
    vibe: dayVibe('full', 'Насыщенный', 'Большой Tokyo', 'День яркий и длинный: лес, улицы, Shibuya Sky и ночной Shinjuku.', 'В Shibuya Sky нужно прийти к своему времени. Если прогулка затянется, сократите аниме-маршрут или магазины.', '🌃'),
    cover: cover.tokyo,
  ...
  },
  {
    ...
    vibe: dayVibe('adventure', 'Приключенческий', 'Охота за Fuji', 'Погода здесь главнее маршрута: когда гора показалась — можно остановиться и просто смотреть.', 'Если Fuji не видно или день затянулся, дополнительные остановки спокойно подождут другого раза.', '🗻'),
    cover: cover.fuji,
    ...
    fact: 'Если 9 октября Fuji спрячется за облаками, всю эту главу можно перенести на 11 октября. Награда переедет вместе с ней.',
    riddle: {
    ...
    timeline: [
      ...
      { id: 'fuji-evening', time: 'Когда вернётесь', title: 'Оставить вечер только для вас', kind: 'rest', details: ['Если силы ещё есть — выйти на короткую прогулку без маршрута: тихие улицы Hamamatsucho, знакомый огонь Tokyo Tower или случайный konbini по дороге.', 'Если день забрал всё — сразу домой, душ, фотографии Fuji и отдых. Ничего догонять не нужно: оба варианта завершают день правильно.'] },
    ],
  },
  {
    id: 'ginza-akihabara',
    ...
    vibe: dayVibe('steady', 'Живой', 'Городской азарт', 'Утро про вкус и покупки, вторая половина — про одну большую охоту в Akihabara.', 'Если JINS или покупки съели время, просто начинаем Akihabara позже и заканчиваем раньше.', '⚡'),
    cover: cover.tokyo,
    mapFile: '2026-10-10-ginza-akihabara.html',
    mapNote: 'Возвращение в JINS отмечено прямо на карте, а порядок дня в приложении подскажет, когда забирать очки.',
  ...
  },
  {
    ...
    vibe: dayVibe('full', 'Насыщенный', 'Между районами', 'Этот день знакомит с очень разными сторонами Tokyo, а вечером в Nakano можно просто выбирать по настроению.', 'Если времени станет меньше, спокойно пропустите короткую остановку: Murakami и Nakano важнее.', '📚'),
    cover: cover.tokyo,
  ...
  },
  {
    ...
    fact: 'Последняя глава ничего не проверяет. Она просто собирает маршрут, фотографии и найденные награды в одну историю.',
    riddle: {
...
export const achievements: Achievement[] = [
  ...
  { id: 'kindled-in-japan', title: 'Kindled in Japan', description: 'Среди Tokyo нашлась искра Dark Souls или Elden Ring. Костёр зажжён — теперь одна будущая печать сможет уступить этому огню.', type: 'secret', image: badge('kindled-in-japan') },
