...
export const tripDays: TripDay[] = [
  ...
  },
  {
    ...
    timeline: [
      ...
      { id: 'akiba-home', time: 'После 21:00', title: 'Вернуться домой по зелёной линии', kind: 'route', details: ['От JR Akihabara по Suica сесть на Yamanote или Keihin-Tohoku Line до Hamamatsucho, выйти по Suica и дойти до жилья.', 'Перед сном заглянуть в план Fuji в дневнике: если гора случилась 9 октября, завтра Asakusa, Ueno, Hama-rikyu, Murakami Library и Nakano; если поездка перенесена, завтра ждёт Fuji.'] },
    ],
  },
  {
    id: 'asakusa-nakano',
    ...
    fact: 'Если план Fuji перенесён на сегодня, эта глава переедет на 9 октября вместе с наградой. Выбрать дату можно в дневнике Юльчоны.',
    riddle: {
