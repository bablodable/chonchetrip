...
export const tripDays: TripDay[] = [
  ...
  },
  {
    ...
    vibe: dayVibe('full', 'Насыщенный', 'Один большой мир', 'Сегодня весь день живёт внутри USJ. За пределами парка ничего успевать не нужно.', 'Сначала смотри на время Express Pass, а между поездками просто исследуй парк.', '🎢'),
    cover: cover.osaka,
  ...
  },
  {
    ...
    vibe: dayVibe('steady', 'Живой', 'Нара, потом Osaka', 'Утро принадлежит храмам и оленям, вечер посвящён Pokémon. Между ними не нужно бороться за идеальный темп.', 'Главное время дня: бронь Pokémon Café в 18:00. Если захочется сократить вечер, оставь в Shinsekai только ужин и один круг под огнями.', '🦌'),
    cover: cover.osaka,
    ...
    fact: 'Shika senbei: специальные рисовые крекеры для оленей. Держи их уверенно и не прячь за спиной.',
    riddle: {
  ...
  },
  {
    ...
    vibe: dayVibe('gentle', 'Лёгкий', 'Перезагрузка в Tokyo', 'После Kyoto у этого дня одна задача: мягко переехать, увидеть первый вечер Tokyo и лечь отдыхать.', 'Tokyo Tower и ужин уже соберут этот день.', '🗼'),
    cover: cover.tokyo,
  ...
  },
  {
    ...
    vibe: dayVibe('steady', 'Живой', 'Городской азарт', 'Утро про вкус и покупки, вторая половина посвящена одной большой охоте в Akihabara.', 'Если JINS или покупки съели время, просто приезжай в Akihabara позже и заканчивай раньше.', '⚡'),
    cover: cover.tokyo,
  ...
  },
  {
    ...
    timeline: [
      ...
      { id: 'sensoji', time: '08:00–09:45', title: 'Разбудить старый Tokyo', kind: 'quest', details: ['Пройди под Kaminarimon, загляни на Nakamise и доберись до Senso-ji, пока храм ещё не растворился в толпе.', 'Если хочется продолжить храмовую коллекцию, покажи отдельную goshuincho в окне goshuin. Служитель добавит новую запись. Это не Eki stamp и не отметка в Passport приложения.', 'Вход на территорию свободный.'] },
  ...
  },
  {
    ...
    vibe: dayVibe('steady', 'Свободный', 'Последний мягкий день', 'Здесь специально много воздуха: один хороший обед, набережная, свободный ужин и дорога домой.', 'Самолёт важнее последнего бонуса. В аэропорт едем без спешки.', '🌙'),
    cover: cover.tokyo,
...
export const achievements: Achievement[] = [
  ...
  { id: 'another-world', title: 'Another World', description: 'На один день Osaka открыла портал в другой мир. Вы вошли туда вдвоём, как и положено героям.', type: 'story', unlockDate: '2026-10-02', image: badge('another-world') },
  ...
  { id: 'kyoto-after-dark', title: 'Kyoto After Dark', description: 'После долгой дороги ждут тёплая купель и огни Kimono Forest. Kyoto умеет награждать тех, кто не спешит.', type: 'story', unlockDate: '2026-10-06', image: badge('kyoto-after-dark') },
  ...
  { id: 'shibuya-incident', title: 'Shibuya Incident', description: 'Shibuya пройден по следам Jujutsu Kaisen. Мировая линия цела, инцидент остался только в аниме.', type: 'secret', image: badge('shibuya-incident') },
