...
export const tripDays: TripDay[] = [
  ...
  },
  {
    ...
    vibe: dayVibe('full', 'Насыщенный', 'Один большой мир', 'Сегодня весь день живёт внутри USJ. За пределами парка ничего успевать не нужно.', 'Приезжай к воротам за 45–60 минут до официального открытия. Внутри сначала сверяйся со временем Express Pass.', '🎢'),
    cover: cover.osaka,
  ...
  },
  {
    ...
    vibe: dayVibe('steady', 'Живой', 'Нара, потом Osaka', 'Утро принадлежит храмам и оленям, вечер посвящён Pokémon. Между ними не нужно бороться за идеальный темп.', 'Главное время дня — бронь Pokémon Café в 18:00. Senbei держи перед собой; если сокращаешь Shinsekai, оставь ужин и один круг под огнями.', '🦌'),
    cover: cover.osaka,
  ...
  },
  {
    ...
    vibe: dayVibe('gentle', 'Чиловый', 'Медленный Kyoto', 'Улицы, заселение, вечерние фонари и домашний ужин складываются в одну неспешную прогулку.', 'Для goshuin нужна отдельная goshuincho; в туристический блокнот храмовые печати не ставят. После заселения ничего не догоняй.', '🍂'),
    cover: cover.kyoto,
  ...
  },
  {
    ...
    vibe: dayVibe('steady', 'Живой', 'Городской азарт', 'Утро про вкус и покупки, вторая половина посвящена одной большой охоте в Akihabara.', 'Редкий и used-мерч сначала сфотографируй и сравни завтра в Nakano. Если покупки затянулись, заканчивай день раньше.', '⚡'),
    cover: cover.tokyo,
  ...
  },
  {
    ...
    vibe: dayVibe('steady', 'Свободный', 'Последний мягкий день', 'Здесь специально много воздуха: один хороший обед, набережная, свободный ужин и дорога домой.', 'Сначала оставь чемоданы в coin locker на Hamamatsucho. В Haneda едем без спешки: самолёт важнее последнего бонуса.', '🌙'),
    cover: cover.tokyo,
