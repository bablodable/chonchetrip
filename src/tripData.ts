export type TimelineItem = {
  ...
  status?: 'fixed-express' | 'express' | 'timed-entry'
  details: string[]
  food?: FoodPlan
}
...
export const tripDays: TripDay[] = [
  ...
  },
  {
    ...
    mapNonRouteScenes: ['sleep-before-shirahama'],
    ...
    timeline: [
      ...
      },
      {
        ...
        kind: 'place',
        details: ['Пройти через Shinsaibashi-suji, заглянуть в konbini по пути и вернуться в отель примерно к 22:30.', 'Проверить прогноз на завтра и собрать всё к раннему выходу. Выйти в 06:50, билет Kuroshio уже куплен.'],
      },
      {
        id: 'sleep-before-shirahama',
        time: '~23:00 · подъём 06:00',
        title: 'Погасить свет перед Shirahama',
        kind: 'rest',
        priority: 'high',
        details: ['Постараться уснуть около 23:00, чтобы получить примерно семь часов сна. Завтра выход в 06:50 и Kuroshio в 07:59.', 'Если первый вечер затянулся, первыми сокращаем Ebisu Tower и Hōzenji, а не сон. Одежду, билеты и завтрак подготовить до отбоя.'],
      },
    ],
  },
  {
    ...
    mapNonRouteScenes: ['sleep-before-usj'],
    ...
    timeline: [
      ...
      { id: 'sleep-before-usj', time: '21:45–22:00 · подъём 05:10', title: 'Лечь раньше ради полного дня в USJ', kind: 'rest', priority: 'high', details: ['Цель — выключить свет не позже 22:00: тогда до подъёма в 05:10 останется чуть больше семи часов.', 'До сна зарядить телефоны и power bank, сохранить билеты, подготовить одежду и купленный заранее завтрак. Завтра выход в 05:55–06:00.'] },
    ],
  },
  {
    id: 'usj',
    ...
    vibe: dayVibe('full', 'Насыщенный', 'Harry Potter · Frieren · Halloween', 'Сегодня не собираем максимум аттракционов: день строится вокруг Harry Potter, Frieren, Halloween и четырёх уже купленных Express Pass.', 'Сразу после входа получи Frieren eTicket. Слоты Factory of Fear 10:50–11:20 и Jurassic Park 20:00–20:30 неподвижны.', '🎢'),
    cover: cover.osaka,
    ...
    mapRouteScenes: [
      ...
      ['usj-gates', 'usj-entry'],
      ['harry-potter'],
      ['return-hollywood', 'factory-of-fear', 'frieren-story-walk', 'hollywood-dream'],
      ['chainsaw-man'],
      ['frieren-lunch', 'flying-dinosaur'],
      ['halloween-position', 'halloween'],
      ['to-jurassic', 'jurassic'],
      ['halloween-finale'],
      ['usj-home'],
    ],
    mapNonRouteScenes: ['resident-evil-check', 'afternoon-reserve', 'halloween-food'],
    ...
    timeline: [
      {
        id: 'to-usj',
        time: '05:55–06:00',
        title: 'Выйти из жилья к самому раннему порталу',
        kind: 'route',
        details: [
          'Цель — приехать к Universal Studios Japan примерно к 06:40–06:50.',
          'Завтрак лучше купить вечером 1 октября: утром не тратить время на кафе и взять еду с собой. USJ иногда начинает впускать раньше официального времени открытия.',
        ],
      },
      {
        id: 'usj-gates',
        time: '06:40–06:50',
        title: 'Занять очередь у входа в Universal Studios Japan',
        kind: 'route',
        details: ['Билеты и официальный USJ app держать открытыми: фактический вход может начаться раньше опубликованного времени.'],
      },
      {
        id: 'usj-entry',
        time: 'Сразу после входа',
        title: 'Получить Frieren Story Walk eTicket на 2 человек',
        kind: 'quest',
        priority: 'must',
        status: 'timed-entry',
        details: [
          'Приоритет №1: сразу открыть официальный USJ app и оформить Timed Entry / eTicket для Frieren Story Walk на двоих.',
          'Желательный слот — примерно 11:30–12:30. Если его нет, брать ближайший удобный после Factory of Fear; если остался только более ранний слот — всё равно брать Frieren и адаптировать следующий порядок.',
        ],
      },
      {
        id: 'harry-potter',
        ...
        priority: 'must',
        details: [
          'Сразу идти в The Wizarding World of Harry Potter: на Forbidden Journey нет нашего Express Pass, поэтому утреннее низкое ожидание используем именно здесь.',
          'После аттракциона немного пройтись по Hogsmeade и при желании взять Butterbeer, но не задерживаться слишком долго.',
        ],
      },
      {
        id: 'return-hollywood',
        time: '~09:15–10:30',
        title: 'Вернуться к Hollywood Area с большим запасом',
        kind: 'route',
        details: ['Спокойно выйти из Hogsmeade и двигаться к району Factory of Fear. Окно включает переход внутри парка и запас перед фиксированным Express Pass.'],
      },
      {
        id: 'factory-of-fear',
        time: '10:50–11:20',
        title: 'Factory of Fear: Zombie Tour',
        kind: 'quest',
        priority: 'must',
        status: 'fixed-express',
        details: ['EXPRESS PASS — фиксированный слот. Первый из четырёх обязательных аттракционов Express Pass: не двигать и не перекрывать Frieren eTicket или другими очередями.'],
      },
      {
        id: 'frieren-story-walk',
        time: '~11:20–13:15 · по eTicket',
        title: 'Frieren Story Walk',
        kind: 'quest',
        priority: 'must',
        status: 'timed-entry',
        details: [
          'Использовать Timed Entry eTicket, полученный сразу после утреннего входа.',
          'Порядок Story Walk и Hollywood Dream можно поменять местами под фактическое время eTicket, не затрагивая Factory of Fear и обед.',
        ],
      },
      {
        id: 'hollywood-dream',
        time: '~11:20–13:15 · до/после Story Walk',
        title: 'Hollywood Dream – The Ride · Frieren DREAM TRACK 3',
        kind: 'quest',
        priority: 'must',
        status: 'express',
        details: [
          'Использовать Express Pass без фиксированного времени. Выбирать обычный Hollywood Dream — НЕ Backdrop.',
          'Для коллаборации включить DREAM TRACK 3 — Frieren: Beyond Journey\'s End × Story Ride. Это второй из четырёх обязательных аттракционов Express Pass.',
        ],
      },
      {
        id: 'resident-evil-check',
        time: '~13:15 · проверить слот 14:30–17:00',
        title: 'Resident Evil Requiem: The Dive — только бонус',
        kind: 'quest',
        priority: 'optional',
        status: 'timed-entry',
        details: ['После использования Frieren Timed Entry проверить USJ app. Брать только удобный слот примерно 14:30–17:00; Resident Evil не должен мешать Frieren, четырём Express Pass, Halloween или Jurassic Park 20:00.'],
      },
      {
        id: 'chainsaw-man',
        time: '~13:15',
        title: 'Chainsaw Man: The Chaos 4-D',
        kind: 'quest',
        priority: 'must',
        status: 'express',
        details: [
          'Использовать Express Pass без фиксированного времени. Это третий из четырёх обязательных аттракционов Express Pass.',
          'После сеанса при желании зайти в Cinema 4-D Store за Frieren / Chainsaw Man merchandise. Не откладывать весь мерч на закрытие парка.',
        ],
      },
      {
        id: 'frieren-lunch',
        time: '~13:45–14:45',
        title: 'Frieren: Restaurant of Memories — обед на двоих',
        kind: 'food',
        priority: 'must',
        food: primaryFood(
          'Обед и отдых',
          "На двоих: Frieren's Plate + Himmel's Plate",
          "Frieren's Plate — тушёная говядина с demi-glace, салат и хлеб в форме навершия посоха (¥3,500). Himmel's Plate — омлет с сырным соусом и гарнирами (¥2,800). Взять по одному сету и попробовать оба.",
          [
            { name: "Fern's Cherry and Blueberry Parfait · ¥2,200", note: 'Один на двоих, если останется место: в комплекте декоративная ложка с бабочкой.' },
            { name: "Eisen and Heiter's Plate · ¥2,800", note: 'Заменить им омлет Himmel, если хочется более сытный сет: Hamburg steak и fish & chips.' },
          ],
        ),
        details: [
          'Restaurant of Memories — это название временной Frieren-коллаборации. Она проходит внутри Lost World Restaurant в зоне Jurassic Park; искать второй ресторан не нужно.',
        ],
      },
      {
        id: 'flying-dinosaur',
        time: '~14:45–16:30',
        title: 'The Flying Dinosaur — если очередь адекватная',
        kind: 'place',
        priority: 'high',
        details: ['Основной дополнительный аттракцион. Он удобно продолжает блок у Lost World / Jurassic Park, но при слишком большой фактической очереди не ломать ради него вечерний маршрут.'],
      },
      {
        id: 'afternoon-reserve',
        time: '~16:30–17:15',
        title: 'Свободный резерв · Nintendo World только как бонус',
        kind: 'rest',
        priority: 'optional',
        details: [
          'Можно вернуться в Harry Potter, выбрать небольшой аттракцион, сделать покупки или просто отдохнуть.',
          'Nintendo World не является приоритетом: добавлять только при очень удобном входе и свободном времени, если это никак не ломает основной план.',
        ],
      },
      {
        id: 'halloween-food',
        time: '~17:15–17:45',
        title: 'Поесть, отдохнуть и подготовиться к Halloween',
        kind: 'food',
        details: ['Это короткая пауза перед вечерним блоком, а не новая длинная очередь. Проверить расписание Zombie de Dance в USJ app.'],
      },
      {
        id: 'halloween-position',
        time: '17:45',
        title: 'Перейти в удобный район для вечернего Halloween',
        kind: 'route',
        details: ['Заранее занять удобную позицию, чтобы в 18:00 уже быть внутри атмосферы Horror Nights, а не идти через весь парк.'],
      },
      {
        id: 'halloween',
        time: '18:00–19:30',
        title: 'Halloween Horror Nights · первый вечерний блок',
        kind: 'place',
        priority: 'must',
        details: ['Главные приоритеты: Street Zombies, Zombie de Dance и вечерняя атмосфера USJ. Не вставлять сюда длинные обычные очереди.'],
      },
      {
        id: 'to-jurassic',
        time: '~19:30',
        title: 'Начать переход к Jurassic Park',
        kind: 'route',
        details: ['Закончить текущую Halloween-активность и идти в Jurassic Park заранее. Полчаса оставлены как разумный запас перед фиксированным Express Pass.'],
      },
      {
        id: 'jurassic',
        time: '20:00–20:30',
        title: 'Jurassic Park: The Ride in the Dark',
        kind: 'quest',
        priority: 'must',
        status: 'fixed-express',
        details: ['EXPRESS PASS — фиксированный слот. Четвёртый обязательный аттракцион нашего Express Pass: не двигать и не рисковать опозданием.'],
      },
      {
        id: 'halloween-finale',
        time: '20:30–22:00',
        title: 'Финальный Halloween-блок',
        kind: 'place',
        priority: 'high',
        details: ['Вернуться к Street Zombies, Zombie de Dance и ночной атмосфере; если расписание позволяет, увидеть последний Zombie de Dance. Не добавлять длинные очереди только ради количества аттракционов.'],
      },
      {
        id: 'usj-home',
        time: '~22:00 · к закрытию',
        title: 'Выйти из парка и вернуться домой',
        kind: 'route',
        details: ['Universal City → JR Yumesaki Line до Nishikujo → Osaka Loop Line до Taisho.', 'На Taisho пересесть в Osaka Metro Nagahori Tsurumi-ryokuchi Line и доехать до Nagahoribashi. Дальше Grand Hostel, душ и зарядка телефонов.'],
      },
    ],
  },
  {
  ...
  },
  {
    ...
    mapNonRouteScenes: ['sleep-before-fushimi'],
    ...
    timeline: [
      ...
      { id: 'kaiseki', time: '18:30 · забронировано', title: 'Поужинать по-домашнему в Kyoto', kind: 'food', food: primaryFood('Ужин', 'Mamaya', 'Домашняя Kyoto-кухня и obanzai: уютно и без лишней торжественности.'), details: ['На двоих, имя Eduard. Подойти к 18:20; подтверждение — в переписке с mamaya.kyoto.', 'Подача может быть дольше в часы пик. После ужина — только Kamo River и возвращение в Tazuru.'] },
      { id: 'sleep-before-fushimi', time: '~22:15 · подъём 06:10', title: 'Закончить вечер перед тысячей тории', kind: 'rest', priority: 'high', details: ['Постараться уснуть около 22:15: подъём в 06:10 даст почти восемь часов сна перед ранним Fushimi Inari.', 'Вечером подготовить воду, удобную обувь и лёгкий завтрак. Завтра выход из Tazuru около 07:05.'] },
    ],
  },
  {
    id: 'fushimi',
    ...
    mapNonRouteScenes: ['sleep-before-arashiyama'],
    ...
    timeline: [
      ...
      { id: 'sleep-before-arashiyama', time: '21:45–22:00 · подъём 05:45', title: 'Уснуть пораньше перед Arashiyama', kind: 'rest', priority: 'high', details: ['Цель — лечь до 22:00 и оставить почти восемь часов сна до подъёма в 05:45. Завтра выход из Tazuru около 06:40.', 'Вечернюю прогулку закончить примерно к 21:00–21:15. До отбоя собрать рюкзак, воду и одежду для длинного прогулочного дня.'] },
    ],
  },
  {
    id: 'arashiyama',
  ...
  },
  {
    ...
    mapNonRouteScenes: ['sleep-before-fuji'],
    ...
    timeline: [
      ...
      { id: 'shinjuku-night', time: '~18:40–20:00', title: 'Пойти туда, где живёт Godzilla', kind: 'place', details: ['Короткий вечерний круг: Omoide Yokocho, Kabukicho и огромная голова над ночным Shinjuku. Сегодня не задерживаться после 20:00 — завтра очень ранний Fuji.'] },
      { id: 'ramen-nagi', time: '~20:00–20:40', title: 'Найти ramen в переулках Golden Gai', kind: 'food', food: primaryFood('Ужин', 'Nagi Golden Gai', 'Насыщенный niboshi-бульон после длинного дня.', undefined, 'Если очередь не позволяет закончить к 20:40, выбрать ближайший быстрый ramen и сохранить сон перед Fuji.'), details: ['Около 20:40 выйти к Oedo Line, доехать до Daimon и вернуться домой примерно к 21:20.'] },
      { id: 'sleep-before-fuji', time: '~22:00 · подъём 05:00', title: 'Выключить неон перед охотой за Fuji', kind: 'rest', priority: 'high', details: ['Постараться уснуть около 22:00, чтобы получить семь часов сна. Завтра выход из жилья в 06:00 и Fuji Excursion из Shinjuku в 07:30.', 'До сна проверить билеты и прогноз, зарядить телефоны, собрать тёплый слой и завтрак. Поздний Shinjuku сегодня уступает силам на Fuji.'] },
    ],
  },
  {
    id: 'fuji',
  ...
  },
  {
    ...
    mapNonRouteScenes: ['sleep-before-asakusa'],
    ...
    timeline: [
      ...
      { id: 'sleep-before-asakusa', time: '22:15–22:30 · подъём 06:10', title: 'Сохранить силы для ранней Asakusa', kind: 'rest', priority: 'high', details: ['Постараться уснуть до 22:30: подъём в 06:10 оставит около восьми часов отдыха перед выходом в 07:05.', 'После возвращения из Akihabara — только душ, зарядка и подготовка одежды. Последний круг по магазинам закончить к 21:00.'] },
    ],
  },
  {
    id: 'asakusa-nakano',
